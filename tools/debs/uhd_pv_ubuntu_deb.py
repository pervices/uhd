...
def main(args):
    ...
    with open("host/cmake/debian-pv/changelog") as cl:
        ...
        if args.nightly:
            ...
            print("uhd_version[0]: " +  uhd_version[0])
            print("uhd_version[1]: " +  uhd_version[1])
            print("uhd_version[2]: " +  uhd_version[2])
            print("uhd_version[3]: " +  uhd_version[3])
    ...
    print("cwd: " + str(uhd_deb_build_path))
    ...
    if not args.nobuild:
        ...
        result = subprocess.run(shlex.split(
            "echo desc; cat ./result uhdpv_{}-0ubuntu1~{}1.dsc; sudo pbuilder build --buildresult ./result uhdpv_{}-0ubuntu1~{}1.dsc".format(uhd_version, args.release, uhd_version, args.release)), cwd=args.buildpath)
        if result.returncode:
