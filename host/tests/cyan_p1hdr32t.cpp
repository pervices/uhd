//This test has been copied from 16t with only the number of tx and rx channels changed. It has not been verified if the test works yet. 2021-06-11
...
constexpr size_t NUM_TX_CHANNELS = 32;
