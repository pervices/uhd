...
#ifndef INCLUDED_UHD_USRP_MULTI_CYAN_64T_HPP
#define INCLUDED_UHD_USRP_MULTI_CYAN_64T_HPP
...
class multi_cyan_64t : public multi_usrp{
public:
    typedef boost::shared_ptr<multi_cyan_64t> sptr;

    multi_cyan_64t(const device_addr_t &addr);
    ~multi_cyan_64t(void);
