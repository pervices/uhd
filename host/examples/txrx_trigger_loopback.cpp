...
int UHD_SAFE_MAIN(int argc, char *argv[]){
    ...
    for(size_t ch = 0; ch < channel_nums.size(); ch++) {
        if(use_tx) {
            std::cout << std::format("Setting ch{} TX Rate: {} Msps...\n", channel_nums[ch], (rate/1e6));
