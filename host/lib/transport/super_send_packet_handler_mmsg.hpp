...
private:
    ...
    UHD_INLINE size_t send_multiple_packets(
        ...
        for(int n = 0; n < num_packets; n++) {
            ...
            packet_header_infos[n].has_tsf = false;!metadata_.end_of_burst; // Every packet except the end of burst must have a timestamp. End of burst must have no timestamp
