...
// NOTE: avoid aligned_alloc and use mmap instead for large buffers
// aligned_alloc causes random latency spikes when said memory is being used. (Experimentally verified, no idea why)
