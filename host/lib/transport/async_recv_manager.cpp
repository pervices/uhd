...
_buffer_write_count_buffer_size((uint_fast32_t) std::ceil(padded_int_fast64_t_size * NUM_BUFFERS / (double) page_size) * page_size),
_buffer_write_count_buffer((uint8_t*) aligned_alloc(padded_int_fast64_t_size, _num_ch * _buffer_write_count_buffer_size)),
