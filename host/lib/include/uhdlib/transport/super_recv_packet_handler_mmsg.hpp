                           ...
                           const bool one_packet)
    {
        ...
        while(samples_received < nsamps_per_buff) [[likely]] {
            ...
            for(size_t ch = 0; ch < _NUM_CHANNELS; ch++) {
                ...
                // TODO: Enable this once EOB flag is properly implemented.
                // This is to unlock the channel when in NUM_SAMPS_AND_DONE mode but since EOB is not implemented 
                // we do not know when it is done.
                ...
                //     flock(_streamer_locks[_channels[ch]], LOCK_UN);
                // }
...
private:
    ...
    // Channel IDs used by streamer
    std::vector<size_t> _channels;
    std::vector<int> _streamer_locks;
    // Track whether the channel is actively streaming or not
