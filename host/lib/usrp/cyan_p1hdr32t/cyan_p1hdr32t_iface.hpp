...
#ifndef INCLUDED_CYAN_P1HDR32T_IFACE_HPP
#define INCLUDED_CYAN_P1HDR32T_IFACE_HPP
...
{
public:
    typedef std::shared_ptr<cyan_p1hdr32t_iface> sptr;
    /*!
...
private:
    ...
    char _buff[ CYAN_P1HDR32T_MAX_MTU ];
};

}

#endif /* INCLUDED_CYAN_P1HDR32T_IFACE_HPP */
