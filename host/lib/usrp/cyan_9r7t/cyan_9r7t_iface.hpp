...
#ifndef INCLUDED_CYAN_9R7T_IFACE_HPP
#define INCLUDED_CYAN_9R7T_IFACE_HPP
...
/*!
 * The cyan_9r7t interface class:
 * Provides a set of functions to UDP implementation layer.
 */
class cyan_9r7t_iface : public uhd::wb_iface
{
public:
    typedef std::shared_ptr<cyan_9r7t_iface> sptr;
    /*!
     * Make a new cyan_9r7t interface with the control transport.
     * \param ctrl_transport the udp transport object
     * \return a new cyan_9r7t interface object
     */
    cyan_9r7t_iface(uhd::transport::udp_simple::sptr ctrl_transport);

    static cyan_9r7t_iface::sptr make(uhd::transport::udp_simple::sptr ctrl_transport);
...
private:
    ...
    char _buff[ CYAN_9R7T_MAX_MTU ];
};

}

#endif /* INCLUDED_CYAN_9R7T_IFACE_HPP */
