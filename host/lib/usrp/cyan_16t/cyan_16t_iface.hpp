...
public:
     ...
     * \return a new cyan_16t interface object
     */
    cyan_16t_iface(uhd::transport::udp_simple::sptr ctrl_transport);

    static cyan_16t_iface::sptr make(uhd::transport::udp_simple::sptr ctrl_transport);
