...
private:
     ...
     * When using this to access properties use the actual path on the server and use the get function in cyan_nrnt_iface instead of the mapping and access command from the property tree
     */
    cyan_nrnt_iface::sptr _iface;
};
