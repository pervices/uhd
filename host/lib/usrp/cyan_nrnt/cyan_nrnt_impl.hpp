...
private:
    ...
    struct mb_container_type{
        ...
        std::vector<std::shared_ptr<uhd::usrp::cyan_nrnt_recv_packet_streamer>> rx_streamers;
        std::vector<std::shared_ptr<uhd::usrp::cyan_nrnt_send_packet_streamer>> tx_streamers;
