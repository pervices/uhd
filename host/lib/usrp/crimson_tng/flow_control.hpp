...
public:
	...
	flow_control( const double nominal_sample_rate, const double nominal_buffer_level_pcnt, const size_t buffer_size, const uhd::pidc & pidc, const double pid_sample_rate )
	:
