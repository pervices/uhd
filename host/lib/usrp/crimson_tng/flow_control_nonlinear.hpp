...
public:
	...
	flow_control_nonlinear( const uhd::flow_control &other )
	:
		buffer_size( other.get_buffer_size() ),
		nominal_buffer_level( other.get_nominal_buffer_level() ),
		nominal_sample_rate( other.get_nominal_sample_rate() ),
		buffer_level( other.get_buffer_level() ),
		sob_time( other.get_sob_time() )
	{
	}

	virtual ~flow_control_nonlinear()
	{
	}
