...
class crimson_tng_recv_packet_streamer : public uhd::transport::sph::recv_packet_streamer_mmsg
{
public:
...
private:
    ...
    // Indicates whether the streamer is actively streaming on this channel
    std::shared_ptr<std::vector<bool>> _rx_streamer_channel_active;
