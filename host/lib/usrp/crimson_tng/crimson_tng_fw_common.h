...
#define CRIMSON_TNG_DEFAULT_NETMASK_ETH1_10G   (255 << 24 | 255 << 16 | 255  << 8  | 0 << 0)
    ...
    #define CRIMSON_TNG_DSP_PER_RFE 1
    #define CRIMSON_TNG_RX_CHANNELS 16
    #define CRIMSON_TNG_TX_CHANNELS 8*CRIMSON_TNG_DSP_PER_RFE
...
// Crimson Buffer Size
//#define CRIMSON_TNG_BUFF_SIZE	(1024*140*512/32)
//#define CRIMSON_TNG_BUFF_SIZE	(1024*9000*(8/512)*16)
#define CRIMSON_TNG_BUFF_SIZE	(2048*140*512/32)
