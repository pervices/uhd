...
#define CRIMSON_TNG_RATE_RANGE_STOP_QUARTER     CRIMSON_TNG_MASTER_CLOCK_RATE/4
...
#define CRIMSON_TNG_ADC_BW                  CRIMSON_TNG_MASTER_CLOCK_RATE/2
#define CRIMSON_TNG_ADC_FREQ_RANGE_ROLLOFF      0.8*CRIMSON_TNG_ADC_BW
#define CRIMSON_TNG_BW_FULL                 CRIMSON_TNG_RATE_RANGE_STOP_FULL/2
...
#define CRIMSON_TNG_DSP_FREQ_RANGE_START_FULL	-CRIMSON_TNG_BW_FULL/2
#define CRIMSON_TNG_DSP_FREQ_RANGE_STOP_FULL	CRIMSON_TNG_BW_FULL/2
#define CRIMSON_TNG_DSP_FREQ_RANGE_START_QUARTER	-CRIMSON_TNG_BW_QUARTER/2
#define CRIMSON_TNG_DSP_FREQ_RANGE_STOP_QUARTER	CRIMSON_TNG_BW_QUARTER/2
