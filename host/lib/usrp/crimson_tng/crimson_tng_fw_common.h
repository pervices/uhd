...
#define CRIMSON_TNG_DSP_FREQ_RANGE_START_FULL	-CRIMSON_TNG_BW_FULL/2.0
#define CRIMSON_TNG_DSP_FREQ_RANGE_STOP_FULL	CRIMSON_TNG_BW_FULL/2.0
#define CRIMSON_TNG_DSP_FREQ_RANGE_START_QUARTER	-CRIMSON_TNG_BW_QUARTER/2.0
#define CRIMSON_TNG_DSP_FREQ_RANGE_STOP_QUARTER	CRIMSON_TNG_BW_QUARTER/2.0
