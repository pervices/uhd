...
#define CRIMSON_RF_TX_GAIN_RANGE_STOP	31.75
#define CRIMSON_RF_TX_GAIN_RANGE_STEP	0.25

// Ranges from, 0dB to 95dB
#define CRIMSON_RF_RX_GAIN_RANGE_START	0.0
#define CRIMSON_RF_RX_GAIN_RANGE_STOP	63.25
#define CRIMSON_RF_RX_GAIN_RANGE_STEP	0.25
