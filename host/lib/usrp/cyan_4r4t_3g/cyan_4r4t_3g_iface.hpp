...
#ifndef INCLUDED_CYAN_4R4T_3G_IFACE_HPP
#define INCLUDED_CYAN_4R4T_3G_IFACE_HPP
...
{
public:
    typedef std::shared_ptr<cyan_4r4t_3g_iface> sptr;
    /*!
...
private:
    ...
    char _buff[ CYAN_4R4T_3G_MAX_MTU ];
};

}

#endif /* INCLUDED_CYAN_4R4T_3G_IFACE_HPP */
