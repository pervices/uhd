...
#define TREE_CREATE_RW(PATH, PROP, TYPE, HANDLER)						\
	do { _tree->create<TYPE> (PATH)								\
		...
		.add_desired_subscriber(std::bind(&cyan_p1hdr16t_impl::set_ ## HANDLER, this, (PROP), ph::_1))	\
		.set_publisher(std::bind(&cyan_p1hdr16t_impl::get_ ## HANDLER, this, (PROP)    ));	\
	} while(0)
...
#define TREE_CREATE_RO(PATH, PROP, TYPE, HANDLER)						\
	do { _tree->create<TYPE> (PATH)								\
    		.set( get_ ## HANDLER (PROP))							\
		.publish  (std::bind(&cyan_p1hdr16t_impl::get_ ## HANDLER, this, (PROP)    ));	\
	} while(0)
...
//    }
    ...
    _tree->create<subdev_spec_t>(mb_path / "rx_subdev_spec").add_coerced_subscriber(std::bind(&cyan_p1hdr16t_impl::update_rx_subdev_spec, this, mb, ph::_1));
    _tree->create<subdev_spec_t>(mb_path / "tx_subdev_spec").add_coerced_subscriber(std::bind(&cyan_p1hdr16t_impl::update_tx_subdev_spec, this, mb, ph::_1));
    ...
    for( size_t dspno = 0; dspno < CYAN_P1HDR16T_RX_CHANNELS; dspno++ ) {
		...
		_tree->create<double> (rx_dsp_path / "rate" / "value")
			...
			.add_desired_subscriber(std::bind(&cyan_p1hdr16t_impl::update_rx_samp_rate, this, mb, (size_t) dspno, ph::_1))
			.set_publisher(std::bind(&cyan_p1hdr16t_impl::get_double, this, ("rx_"+lc_num+"/dsp/rate")    ));
    ...
    for( int dspno = 0; dspno < CYAN_P1HDR16T_TX_CHANNELS; dspno++ ) {
		...
		_tree->create<double> (tx_dsp_path / "rate" / "value")
			...
			.add_desired_subscriber(std::bind(&cyan_p1hdr16t_impl::update_tx_samp_rate, this, mb, (size_t) dspno, ph::_1))
			.set_publisher(std::bind(&cyan_p1hdr16t_impl::get_double, this, ("tx_"+lc_num+"/dsp/rate")    ));
