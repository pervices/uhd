...
#ifndef INCLUDED_CYAN_64T_IFACE_HPP
#define INCLUDED_CYAN_64T_IFACE_HPP
...
/*!
 * The cyan_64t interface class:
 * Provides a set of functions to UDP implementation layer.
 */
class cyan_64t_iface : public uhd::wb_iface
{
public:
    typedef boost::shared_ptr<cyan_64t_iface> sptr;
    /*!
     * Make a new cyan_64t interface with the control transport.
     * \param ctrl_transport the udp transport object
     * \return a new cyan_64t interface object
     */
    cyan_64t_iface(uhd::transport::udp_simple::sptr ctrl_transport);

    static cyan_64t_iface::sptr make(uhd::transport::udp_simple::sptr ctrl_transport);
...
private:
    ...
    char _buff[ CYAN_64T_MAX_MTU ];
};

}

#endif /* INCLUDED_CYAN_64T_IFACE_HPP */
