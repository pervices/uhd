...
#define CYAN_4R4T_LO_DIFF             250000000
//UNDESIRABLE_LO_START contains
#define CYAN_4R4T_UNDESIRABLE_LO_START {CYAN_4R4T_FM_LOWERLIMIT}
#define CYAN_4R4T_UNDESIRABLE_LO_STOP {CYAN_4R4T_FM_UPPERLIMIT}
